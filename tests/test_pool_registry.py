...
ck("pearlfortune image 正确", S.POOLS["pearlfortune"]["image"] == "docker.io/mrkidbk/pearl-miner-pearlfortune:v1.1.1")
...
ck("effective_image 取 pearlfortune 镜像", S.effective_image({"pool": "pearlfortune"}) == "docker.io/mrkidbk/pearl-miner-pearlfortune:v1.1.1")
if fails: print(f"\n{fails} 失败"); sys.exit(1)
print("\n全部通过")
